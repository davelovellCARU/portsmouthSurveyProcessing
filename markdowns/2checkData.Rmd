...
lookFileDir <- "O:\\WCC\\Learning and Development\\Research\\PROJECT - Portsmouth 2019 onwards\\Data\\unclean"
          ...
          attenders18 <- paste(lookFileDir, "attenders2018Unclean.xlsx", sep = "\\")
...
ifelse(file.exists(here("data/attenders2018Unclean.xlsx")),
       "Portsmouth 2019 File Found :)",
       {
         # If file exists on O drive
         ...
         allFilesThere <- FALSE
       "Attenders 2018 file not found and O:// drive not available: Please place 'portsmouthLeaders2019.xlsx' in the 'data' directory and knit this document again"}})
```
