...
if(readRDS(here("data/progressRdats/2.rdat"))){
  ...
  continue = FALSE
  writeLines("2checkData.Rmd succesfully rendered, but unable to continue. Very likely that \"portsmouthLeaders2018\" or \"portsmouthLeaders2019\" are not in the \"data\" directory. See \"markdowns\\2checkData.html\" for details")
}
```