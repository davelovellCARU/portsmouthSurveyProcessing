...
3. Those who are 'churched' (excluding `grewUp`s) but not 'blending' are assigned another `class2` value, based on their response to **question 7**. Either
  ...
  b. Tickers of `because of a different reason (please specify)` are encoded as one of the above (if they are bad at surveys), or dropped into the catchall category (`family`) of "family, friends, or life patterns".
