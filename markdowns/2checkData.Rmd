...
ifelse(file.exists(here("data/portsmouthLeaders2018.xlsx")),
       ...
       {allFilesThere <- FALSE
         writeLines("Portsmouth 2018 File not Found: Please place 'portsmouthLeaders2018.xlsx' in the 'data' directory and knit this document again")})
...
ifelse(file.exists(here("data/portsmouthLeaders2019.xlsx")),
       ...
       {allFilesThere <- FALSE
         writeLines("Portsmouth 2019 File not Found: Please place 'portsmouthLeaders2019.xlsx' in the 'data' directory and knit this document again")})
```
