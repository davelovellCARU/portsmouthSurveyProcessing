...
responses %<>%
  mutate_at(c("info_deanery", "lead_gender", "df_denominationalFeatures",
              ...
              "mis_dynamic", "sac_whoPresidesCommunion", "ste_responsibleDecisions" 
              ), as.factor) 
...
splitTibs[["2018"]] %<>% 
  mutate(info_startTime= 
           lubridate::as_datetime(info_startTime, origin = "2090-01-01"),
         info_endTime = 
           lubridate::as_datetime(info_endTime, origin = "2090-01-01"))
